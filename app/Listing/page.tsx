    ...
    <main>
      ...
      <section className={styles.section}>
        <div className={`container ${styles.split}`}>
          <div className={styles.revCard}>
            ...
            <div className={styles.revNumbers}>
              <div className={styles.big}>60</div>
              <div className={styles.slash}>/</div>
              <div className={styles.small}>40</div>
            </div>
      ...
      <section className={styles.dark}>
        <div className={`container ${styles.darkInner}`}>
          ...
          <div className={styles.footerLine}>We care about long term partnerships, not quick wins.</div>
        </div>
      </section>
