...
export default function Listing() {
  return (
    ...
    <div className={`hero-divider ${styles.heroDivider}`}></div>
...
<section className={`section ${styles.section}`}>
  <div className={`container split ${styles.split}`}>
    <div className={`rev-card ${styles.revCard}`}>
      <div className={`rev-top ${styles.revTop}`}>REVENUE SPLIT</div>

      <div className={`rev-numbers ${styles.revNumbers}`}>
        <div className={`big ${styles.big}`}>60</div>
        <div className={`slash ${styles.slash}`}>/</div>
        <div className={`small ${styles.small}`}>40</div>
      </div>

      <div className={`rev-bar ${styles.revBar}`}>
        <span></span>
      </div>

      <div className={`rev-note ${styles.revNote}`}>
        The larger share goes to the <strong>building partner</strong>.
      </div>
    </div>

    <div className={`split-text ${styles.splitText}`}>
      <h2>A fair and transparent split</h2>
      <p>
        We believe the building should benefit properly from the address it provides, and we structure our partnerships to reflect that.
      </p>

      <ul className={`ticks ${styles.ticks}`}>
        <li>
          <span className={`tick ${styles.tick}`}>
...
<section className={`section ${styles.section}`}>
  <div className="container">
    <div className={`title-center ${styles.titleCenter}`}>
      <h2>How we support you</h2>
      <div className={`underline ${styles.underline}`}></div>
    </div>

    <div className={`cards ${styles.cards}`}>
      <div className={`info-card ${styles.infoCard}`}>
        <div className={`ic ${styles.ic}`} aria-hidden="true">
        ...
        <p>
          Running a virtual office properly takes time. We manage all client onboarding, including KYC and AML checks, handled thoroughly in-house.
        </p>
      </div>
      ...
      <div className={`info-card ${styles.infoCard}`}>
        <div className={`ic ${styles.ic}`} aria-hidden="true">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M7 14V7a5 5 0 0 1 10 0v7" stroke="#13b6a6" strokeWidth="2" />
          </svg>
        </div>
        <h3>Low effort for your team</h3>
        <p>
          Your role is simple. Mail is received and stored securely. You take care of the basics, we handle the rest.
        </p>
      </div>
        ...
        <div className={`ic ${styles.ic}`} aria-hidden="true">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path
              ...
              strokeLinecap="round"
            />
            <path d="M8 11h6" stroke="#13b6a6" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
        <h3>Strong listings</h3>
        <p>
          We create high quality, SEO optimised listings for each partner to attract legitimate businesses and protect the location.
        </p>
      </div>
    </div>
  </div>
...
<section className={`dark ${styles.dark}`}>
  <div className={`container dark-inner ${styles.darkInner}`}>
    <h2>
    ...
    <p>
      We operate our own virtual office, so we understand how these services work day to day. That experience shapes how we onboard clients, manage post, and protect the reputation of each address.
    </p>

    <div className={`quote ${styles.quote}`}>
      <em>
        “We have seen the other side of the industry: unfair revenue splits, poor marketing, and compliance checks not carried out to standard.”
      </em>
      <br />
      <strong>Those experiences are exactly why we built Virtual Office Anywhere differently.</strong>
    </div>

    <div className={`footer-line ${styles.footerLine}`}>
    ...
    <div className={`cta ${styles.cta}`}>
      ...
      <div className={styles.ctaContent}>
        ...
        <div className={`btns ${styles.btns}`}>
          <a className={`btn primary ${styles.primaryBtn}`} href="#">
            Get in touch
          </a>
          <a className={`btn ${styles.ghostBtn}`} href="#">
            Learn More
          </a>
        </div>
