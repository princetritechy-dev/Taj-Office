...
function MiniCard(props: { title: string; desc: string }) {
  return (
    <div className="miniCard">
      <div className="miniDot" aria-hidden="true" />
      <div>
        <div className="miniTitle">{props.title}</div>
        <div className="miniDesc">{props.desc}</div>
      </div>
    </div>
  );
}
...
function TestimonialCard(props: { quote: string; name: string; role: string; avatar?: string }) {
  return (
...
function CompareRow(props: { label: string }) {
  return (
    <div className="compareRow">
      <div className="compareLabel">{props.label}</div>
    </div>
  );
}
